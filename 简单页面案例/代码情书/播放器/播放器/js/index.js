$(function () {
    ...
    var musicImgsData = ['img/明天会更好.jpg', 'img/与你同在.jpg', 'img/奉献.jpg', 'img/人世间.jpg']    // 图片地址数组
    var musicNameData = ['明天会更好', '与你同在', '奉献', '人世间'];                   // 歌曲名数组
    var artistNameData = ['小虾', '黎子喵', 'GAga', '抹茶夹心饼干',]            // 创作歌手数组
    var musicUrls = ['music/明天会更好.mp3', 'music/与你同在.mp3', 'music/奉献.mp3', 'music/人世间.mp3'];// 歌曲mp3数组
